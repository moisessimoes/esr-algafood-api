...
create table grupo_usuario (usuario_id bigint not null, grupo_id bigint not null) engine=InnoDB;
...
alter table grupo_usuario add constraint FKsefl4bg3whol4iks53t2mgc9l foreign key (grupo_id) references grupo (id);
alter table grupo_usuario add constraint FKnoonyfhrgll54jvve2bhld4va foreign key (usuario_id) references usuario (id);
