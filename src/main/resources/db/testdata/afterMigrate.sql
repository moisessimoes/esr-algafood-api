...
insert ignore into cozinha (id, nome) values (2, 'Portuguesa');
insert ignore into cozinha (id, nome) values (3, 'Canadense');
insert ignore into cozinha (id, nome) values (4, 'Japonesa');
...
(7, 'Moisés Simões', 'moises.simoes.dev@gmail.com', '123', utc_timestamp);
